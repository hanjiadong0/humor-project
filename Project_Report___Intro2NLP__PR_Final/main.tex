...
For the headline task, Mistral scores are relatively stable across generator sources (Table~\ref{tab:headline_source_mistral}), supporting the use of Mistral as a more comparable evaluator across generators.
...
(iii) incoherent setup-payoff transitions, and
(iv) generic templates that reduce surprise.
...
Future work should incorporate small-scale human preference judgments, pairwise comparisons, or multi-evaluator consensus to improve robustness and reduce evaluator-specific artifacts.

\paragraph{Better control of constraint satisfaction.}
